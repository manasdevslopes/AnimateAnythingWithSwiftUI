//
//  Present_and_Dismiss_Transition.swift
//  JustAnimateSwiftUI
//
...
struct Present_and_Dismiss_Transition: View {
    var body: some View {
        OpenSettingsView()
    }
}
...
struct Present_and_Dismiss_Transition_Previews: PreviewProvider {
    static var previews: some View {
        Present_and_Dismiss_Transition()
    }
}
