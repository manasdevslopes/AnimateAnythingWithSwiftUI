//
//  DodgeballAnime.swift
//  JustAnimateSwiftUI
//
//  Created by MANAS VIJAYWARGIYA on 25/07/21.
//
...
struct DodgeballAnime: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                SpriteView(scene: scene).frame(width: 320, height: 650)
            }
        }
    }
}

struct DodgeballAnime_Previews: PreviewProvider {
